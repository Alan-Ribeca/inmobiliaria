    ...
    <>
      <section className="footer">
        ...
        <div className="contactanos">
          ...
          <p className="infoContacto">Av. Francia 258, Rosario, Argentina</p>
          <p className="infoContacto">Tel: +54 3402473859</p>
          <p className="infoContacto">info@inmoHome.com</p>
        </div>

        <div className="suscribite">
          <h3 className="suscribiteTitle">Suscribete</h3>
      ...
      <p className="pFinal">
        © 2024 InmoHome. Gracias por visitar la pag, espero que te haya sido de
        su agrado. Un saludo!
      </p>
    </>
  );
